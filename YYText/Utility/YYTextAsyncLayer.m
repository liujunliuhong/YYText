...
- (void)_displayAsync:(BOOL)async {
    ...
    if (async) {
        ...
        dispatch_async(YYTextAsyncLayerGetDisplayQueue(), ^{
            ...
            imageRendererFormat.opaque = opaque;
            imageRendererFormat.scale = scale;
            
            UIGraphicsImageRenderer *imageRender = [[UIGraphicsImageRenderer alloc] initWithSize: size format:imageRendererFormat];
        ...
        UIGraphicsImageRendererFormat *imageRendererFormat = [UIGraphicsImageRendererFormat defaultFormat];
        imageRendererFormat.opaque = self.opaque;
        imageRendererFormat.scale = self.contentsScale;
        
        UIGraphicsImageRenderer *imageRender = [[UIGraphicsImageRenderer alloc] initWithSize:self.bounds.size format:imageRendererFormat];
